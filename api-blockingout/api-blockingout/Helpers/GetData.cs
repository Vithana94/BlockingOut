...
namespace api_rate.Helpers
{
    public class GetData : IGetData
    {
                    ...
                    if (this.mySqlCon != null)
                    {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            foreach (DataRow dtRow in dt.Rows)
                            {
                                ...
                                objBlockingOutDetails.Status = dtRow["Status"].ToString().Trim();
        ...
        public BlockingOutApp GetApplicationByUserIdAndId(BlockingOutApp objApplication, ref ReturnMsgInfo returnMsg)
        {
            BlockingOutApp objRetBlockingOut = new BlockingOutApp();
            this.objConMain = new Connection_Main();
            ...
            else
            {
                try
                {
                    ...
                    if (this.mySqlCon != null)
                    {
                        strSql = "SELECT * FROM tbl_blockingout_applications WHERE Id = '" + objApplication.ID + "' AND UserId = '"+ objApplication.UserID +"';";
                        da = new MySqlDataAdapter(strSql, this.mySqlCon);
                        ds = new DataSet();
                        da.Fill(ds, "BlockingOut");
                        dt = ds.Tables["BlockingOut"];
        ...
        // Get List of all Blocking Out applications
        public List<BlockingOutApp> GetAllApplications(BlockingOutApp objApplication, ref ReturnMsgInfo returnMsg)
        {
            List<BlockingOutApp> lstRetBlockingOut = new List<BlockingOutApp>();
            this.objConMain = new Connection_Main();
            ...
            else
            {
                try
                {
                    ...
                    if (this.mySqlCon != null)
                    {
                        strSql = "SELECT * FROM tbl_blockingout_applications;";
                        da = new MySqlDataAdapter(strSql, this.mySqlCon);
                        ds = new DataSet();
                        da.Fill(ds, "BlockingOut");
                        dt = ds.Tables["BlockingOut"];
        ...
        public List<BlockingOutApp> GetApplicationsStatusforDate(BlockingOutApp objApplication, ref ReturnMsgInfo returnMsg)
        {
            List<BlockingOutApp> lstRetBlockingOut = new List<BlockingOutApp>();
            this.objConMain = new Connection_Main();
            ...
            else
            {
                try
                {
                    ...
                    if (this.mySqlCon != null)
                    {
                        strSql = "SELECT * FROM tbl_blockingout_applications WHERE WHERE Status ='" + objApplication.Status + "' AND DateApplied BETWEEN '" + objApplication.StartDate + "' AND '" + objApplication.EndDate + "';";
                        da = new MySqlDataAdapter(strSql, this.mySqlCon);
                        ds = new DataSet();
                        da.Fill(ds, "BlockingOut");
                        dt = ds.Tables["BlockingOut"];
