...
{
    [JwtCustomAuth]
    public class FireAppByIdUserController : ApiController
    {
        private IGetData _getData = null;

        public FireAppByIdUserController(IGetData IGetData)
        {
            _getData = IGetData;
        }
        ...
        public FireAppByIdOutput Post([FromBody]FireCertificateApplication objFireApplication)
        {
            ...
            try
            {
                ...
                else if (objFireApplication.user == null || objFireApplication.user == "")
                {
                ...
                else
                {
                    ...
                    objFireApp = _getData.GetApplicationByIdUser(objFireApplication, ref objReturnMsg);
