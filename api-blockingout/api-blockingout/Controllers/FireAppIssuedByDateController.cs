...
{
    [JwtCustomAuth]
    public class FireAppIssuedByDateController : ApiController
    {
        private IGetData _getData = null;

        public FireAppIssuedByDateController(IGetData IGetData)
        {
            _getData = IGetData;
        }
        ...
        public FireAppDetailsOutput Post([FromBody]FireCertificateApplication objFireApplication)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    objFireApplication.Status = Globals.ISSUED.ToString().Trim();
