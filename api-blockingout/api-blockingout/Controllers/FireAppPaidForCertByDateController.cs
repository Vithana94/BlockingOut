...
{
    public class FireAppPaidForCertByDateController : ApiController
    {
        private IGetData _getData = null;

        public FireAppPaidForCertByDateController(IGetData IGetData)
        {
            _getData = IGetData;
        }

        // POST /api/FireAppPaidForCertByDate
        public FireAppDetailsOutput Post([FromBody]FireCertificateApplication objFireApplication)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    objFireApplication.Status = Globals.PAIDFORCERT.ToString().Trim();
