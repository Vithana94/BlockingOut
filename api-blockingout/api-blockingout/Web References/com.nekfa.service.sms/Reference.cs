...
namespace api_rate.com.nekfa.service.sms {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="NekfaSMS_APISoap", Namespace="http://tempuri.org/")]
    public partial class NekfaSMS_API : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public NekfaSMS_API() {
            this.Url = global::api_rate.Properties.Settings.Default.api_boutique_com_nekfa_service_sms_NekfaSMS_API;
        ...
        public void SendSMS(string receviedTP, string message, string sendType, string Client, string userName, string project, int fromNoFile) {
        ...
        /// <remarks/>
        public void SendSMSAsync(string receviedTP, string message, string sendType, string Client, string userName, string project, int fromNoFile) {
            this.SendSMSAsync(receviedTP, message, sendType, Client, userName, project, fromNoFile, null);
        }
        
        /// <remarks/>
        public void SendSMSAsync(string receviedTP, string message, string sendType, string Client, string userName, string project, int fromNoFile, object userState) {
            ...
            this.InvokeAsync("SendSMS", new object[] {
                        ...
                        userName,
                        project,
                        fromNoFile}, this.SendSMSOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/SendSMS1", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string SendSMS1(string receviedTP, string message, string sendType, string Client, string userName, string project, int fromNoFile) {
        ...
        /// <remarks/>
        public void SendSMS1Async(string receviedTP, string message, string sendType, string Client, string userName, string project, int fromNoFile) {
            this.SendSMS1Async(receviedTP, message, sendType, Client, userName, project, fromNoFile, null);
        }
        
        /// <remarks/>
        public void SendSMS1Async(string receviedTP, string message, string sendType, string Client, string userName, string project, int fromNoFile, object userState) {
            ...
            this.InvokeAsync("SendSMS1", new object[] {
                        ...
                        userName,
                        project,
                        fromNoFile}, this.SendSMS1OperationCompleted, userState);
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/ReadFile", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string ReadFile() {
            object[] results = this.Invoke("ReadFile", new object[0]);
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void ReadFileAsync() {
            this.ReadFileAsync(null);
        }
        
        /// <remarks/>
        public void ReadFileAsync(object userState) {
            ...
            this.InvokeAsync("ReadFile", new object[0], this.ReadFileOperationCompleted, userState);
        }
